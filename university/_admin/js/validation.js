...
if(confirm(" Are You sure to delete...?"))
{
	document.exam_view.act.value="exam_delete";
	document.exam_view.exam_id.value=exam_id;
	document.exam_view.submit();
}
}
...
//////******************Exam Checking Validation**************////////////////

function validate_exam(exam_add)
{
	
	//Student Name
	if(exam_add.exam_title.value=="")
	{
		alert("Enter Exam Title:");
		exam_add.exam_title.focus();
		return false;
	}
	if(exam_add.exam_date.value=="")
	{
		alert("Enter Exam Date:");
		exam_add.exam_date.focus();
		return false;
	}
	if(exam_add.exam_course.value==0)
	{
		alert("Enter Exam Course:");
		exam_add.exam_course.focus();
		return false;
	}
	if(exam_add.exam_subject.value==0)
	{
		alert("Enter Exam Subject:");
		exam_add.exam_subject.focus();
		return false;
	}
	if(exam_add.exam_time[0].checked==false && exam_add.exam_time[1].checked==false)
	{
		alert("Plz Select Exam Timing");
		exam_add.exam_time[0].checked=true;
		return false;
	}
