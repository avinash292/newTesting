...
<table width="824" height="276" border="1" align="center" class="t1">
  ...
  <tr>
	...
	<img src="_admin/uploads/<?php echo $data[st_image];?>" height="180" width="180" style="border:2px solid black;" />
...
<table width="825" height="75" border="none" align="center">
  ...
  <?php
$i=0;
$sql="select * from exam where exam_course in(select st_course from student where st_id='$_SESSION[student_user]')";
...
<table width="200" border="1" align="center" style="padding-left:50px;">
  <tr><td>
